...
Install the master server package
   ...
   Check :ref:`get_and_install_debian` for instructions how to install the package.
...
Now that you are done with your quick and dirty installation, you can try connecting clients to your fresh LizardFS instance. This is documented in the :ref:`connectclient` part of the :ref:`adminguide`.
